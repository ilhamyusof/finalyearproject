...
<div class="box box-primary">
  <div class="box-header with-border">
    <h3 class="box-title"><b>Room/Hall Reservation</b></h3>
  </div>
  <!-- /.box-header -->
  <!-- form start -->
  <form role="form" action="<?php echo WEB_ROOT; ?>api/process.php?cmd=book" method="post">
    <div class="box-body">
      ...
      <div class="form-group">
        ...
        <input type="text" name="venue" class="form-control input-sm"  placeholder="Venue" id="">
      ...
      <div class="form-group">
		...
		<span id="sprytf_duration">
        <input type="text" name="duration" class="form-control input-sm"  placeholder="Duration" id="">
		<span class="textfieldRequiredMsg">Event Duration is required.</span>
		</span>
      </div>
...
var sprytf_duration 	= new Spry.Widget.ValidationTextField("sprytf_duration", 'none', {validateOn:["blur", "change"]});
var sprytf_phonenum 	= new Spry.Widget.ValidationTextField("sprytf_phonenum", 'none', {validateOn:["blur", "change"]});
//-->
</script>
