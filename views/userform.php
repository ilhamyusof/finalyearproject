  ...
  <form role="form" action="<?php echo WEB_ROOT; ?>views/process.php?cmd=create" method="post">
    <div class="box-body">
      ...
      <div class="form-group">
		...
		<input type="text" name="pwd" class="form-control input-sm" placeholder="Password">
		<span class="textfieldRequiredMsg">Password is required.</span>
		<span class="textfieldMinCharsMsg">Password must specify at least 12 characters.</span>
		</span>
      </div>
	  <div class="form-group">
